...
4. Publish the module: `cd server && spacetime publish evogolf -s local -y`
5. Install client dependencies if needed: `cd client && npm install`
6. Generate client bindings: `spacetime generate --lang typescript --out-dir client/src/module_bindings --module-path server`
